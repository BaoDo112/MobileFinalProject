...
| AUTH-01 | Phase 1 (v1.2) | UI Implemented |
| AUTH-02 | Phase 1 (v1.2) | UI Implemented |
| AUTH-03 | Phase 1 (v1.2) | UI Implemented |
| GALL-01 | Phase 1 (v1.2) | UI Implemented |
| GALL-02 | Phase 1 (v1.2) | UI Implemented |
| GALL-03 | Phase 1 (v1.2) | UI Implemented |
| GALL-04 | Phase 1 (v1.2) | UI Implemented |
| PASS-01 | Phase 1 (v1.2) | UI Implemented |
| PASS-02 | Phase 1 (v1.2) | UI Implemented |
| ORG-01 | Phase 1 (v1.2) | UI Implemented |
| ORG-02 | Phase 1 (v1.2) | UI Implemented |
| ORG-03 | Phase 1 (v1.2) | UI Implemented |
| COMM-01 | Phase 1 (v1.2) | UI Implemented |
| COMM-02 | Phase 1 (v1.2) | UI Implemented |
...
*Last updated: 2026-05-04 after completing the v1.2 UI implementation milestone*
